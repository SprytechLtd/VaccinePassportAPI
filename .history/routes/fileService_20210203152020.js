...
module.exports = {
    ...
    convertToJSONFile: async function (fileJSON) {
        try {
            fs.writeFile(path.join(__dirname, '/jsonFiles/', 'file.json'), JSON.stringify(fileJSON), (error) => {
                if (error) {
                    console.log('error at uploadFile method')
                    console.log(err.message);
                    return {};
                    ...
                    return "file created and converted to json";
                }
            });
            //return fileData
    ...
    loadJsonFile: async function (filePath) {
        try {
            ...
            var extname = path.extname(path.join(__dirname,'/jsonFiles/','file.json'));
